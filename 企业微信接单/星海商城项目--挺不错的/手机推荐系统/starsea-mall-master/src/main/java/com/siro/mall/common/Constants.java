...
public class Constants {
    ...
    public final static int INDEX_GOODS_HOT_NUMBER = 4;//首页热卖手机数量
    public final static int INDEX_GOODS_NEW_NUMBER = 5;//首页新品数量
    public final static int INDEX_GOODS_RECOMMOND_NUMBER = 10;//首页推荐手机数量

    public final static int SHOPPING_CART_ITEM_TOTAL_NUMBER = 13;//购物车中手机的最大数量(可根据自身需求修改)

    public final static int SHOPPING_CART_ITEM_LIMIT_NUMBER = 5;//购物车中单台手机的最大购买数量(可根据自身需求修改)
    ...
    public final static int SELL_STATUS_UP = 0;//手机上架状态
    public final static int SELL_STATUS_DOWN = 1;//手机下架状态
}
