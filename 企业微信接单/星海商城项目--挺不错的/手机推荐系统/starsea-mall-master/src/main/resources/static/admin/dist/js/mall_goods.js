$(function () {
    $("#jqGrid").jqGrid({
        ...
        datatype: "json",
        colModel: [
            {label: '手机编号', name: 'goodsId', index: 'goodsId', width: 60, key: true},
            {label: '手机名', name: 'goodsName', index: 'goodsName', width: 120},
            {label: '手机简介', name: 'goodsIntro', index: 'goodsIntro', width: 120},
            {label: '手机图片', name: 'goodsCoverImg', index: 'goodsCoverImg', width: 120, formatter: coverImageFormatter},
            {label: '手机库存', name: 'stockNum', index: 'stockNum', width: 60},
            {label: '手机售价', name: 'sellingPrice', index: 'sellingPrice', width: 60},
            {
                label: '上架状态',
    ...
    function coverImageFormatter(cellvalue) {
        return "<img src='" + cellvalue + "' height=\"80\" width=\"80\" alt='手机主图'/>";
    }
